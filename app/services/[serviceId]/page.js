...
export default async function Page({ params }) {
  ...
  const { id, name, duration, price, imageUrl, description } = service;
  ...
  return (
    <div className="max-w-6xl mx-auto mt-8">
      <div className="grid grid-cols-[3fr_4fr] gap-20 border border-primary-800 py-3 px-10 mb-24">
        ...
        <div>
          <h3 className="text-accent-100 font-black text-5xl mb-5 translate-x-[-254px] bg-primary-950 p-6 pb-1 w-[100%]">
            {name}
          </h3>
